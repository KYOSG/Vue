    ...
    <el-card>
      <div>
        ...
        <el-table
          ...
          <el-table-column label="专业名称" prop="type"></el-table-column>
          <el-table-column label="最低录取位次" prop="code"></el-table-column>
          <el-table-column label="专业名称" prop="name"></el-table-column>
          <el-table-column label="选课要求" prop="level1_name"></el-table-column>
        </el-table>
        <!--分页-->
        <el-pagination
